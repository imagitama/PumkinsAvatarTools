...
{
    [InitializeOnLoad]
    public static class ScriptDefineManager
    {
        /// <summary>
        ...
        /// <summary>
        /// Checks if any of the defines are set for current build target
        /// </summary>
        /// <param name="defineStrings"></param>
        /// <returns></returns>
        public static bool IsDefinedAny(params string[] defineStrings)
        {
            return defineStrings.Any(IsDefined);
        }

        /// <summary>
        /// Checks if any defines are set for <paramref name="buildTarget"/>
        /// </summary>
        /// <param name="buildTarget"></param>
        /// <param name="defineStrings"></param>
        /// <returns></returns>
        public static bool IsDefinedAny(BuildTargetGroup buildTarget, params string[] defineStrings)
        {
            return defineStrings.Any(s=> IsDefined(buildTarget, s));
        }
